...
public class TaskController {
    ...
    @GetMapping
    public PageResponseDTO<TaskResponseDTO> getAllTasks(@RequestParam(required = false) Boolean completed,
        ...
        return PageResponseDTO.of(taskPage.map(this::mapToResponse));
    }
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<TaskResponseDTO> patchTask(@PathVariable Long id, @RequestBody TaskRequestDTO taskRequest) {
