...
public class TaskServiceTest {
    ...
    /*
     * @Mock -> creates a mock object of TaskRepository, means real DB is not used here, instead
    ...
    /* 
     * creates and instance of taskService and injects the above mock taskRepository into it.
    ...
    */
    ...
    /*
     * runs before every @Test method, intializes mock objects so that they are ready to use
     */
    @BeforeEach
    void setUp(){
    ...
    void testCreateTask() {
        ...
        TaskRequest request = new TaskRequest("New Task", "New Description", false); 
    ...
    void testUpdateTask_Found() {
       ...
       TaskRequest updateRequest = new TaskRequest("Updated Title", "Updated Desc", false);
